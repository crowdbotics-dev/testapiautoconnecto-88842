...
## Project Structure
    ...
    ├── testapiautoconnecto_88842  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_88842`
...
2. Clone this repo and `cd testapiautoconnecto_88842`
